<?php
	...
	if ($db_handle) {
		...
		$sql = "SELECT * FROM article WHERE Type = 'ferraille'";
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="styles_ferraille.css">
...
<body>
	...
	<header class="page-header header container-fluid">
		...
		<div class="description">
			<h1>Découvrez nos articles de la catégorie "Ferraille et Trésors".</h1>
		</div>
	</header>
