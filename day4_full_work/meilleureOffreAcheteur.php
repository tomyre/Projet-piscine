<?php
	...
	if ($db_handle) {
		...
		$sql = "SELECT * FROM article WHERE Categorie = 'Offre' OR Categorie2 = 'Offre'";
...
?>
					<tr>
						...
						<td><button class="btn btn-outline-secondary btn-lg"><a href="faireOffre.html">Faire une offre</a></td>
					</tr>
<?php
				}
?>
